        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="card-header mt-3">
                    ...
                    <h1 class="mt-4">Lịch sử xuất hàng</h1>
                    <div class="card mb-4">
                    <?php if (isset($_GET['msg'])){
                            ...
                            <?php } else { ?>
                                ...
                                <strong>Không thể xuất hàng vì số lượng xuất nhiều hơn số lượng sản phẩm trong kho !</strong>
                            </div>
                            <?php }  ?> 
                            <?php }  ?>   
                        <div class="card-body">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <select class="form-select" aria-label="Default select example" id="theloai" tabindex="8" name="sp" required>
                                                                    ...
                                                                    <?php
                                                                     $lsp = mysqli_query($connect, "SELECT * FROM sanpham WHERE tinhtrang = 'Hoạt động' AND soluong > 0 ORDER BY id DESC");
