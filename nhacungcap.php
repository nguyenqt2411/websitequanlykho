                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                <?php 
                                    $query = "SELECT * FROM nhacungcap Order by id desc";
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Nhà cung cấp : <?php echo $arUser["tennhacungcap"] ?>
                                                    ...
                                                    <form action="function.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-12">
                                                            <label for="category-film"
                                                                class="col-form-label">Tên nhà cung cấp:</label>
                                                                <input type="text" class="form-control" id="category-film" value="<?php echo $arUser["tennhacungcap"] ?>" name="tennhacungcap" required>
                                                        </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="col-12">
                                                            <label for="category-film"
                                                                class="col-form-label">Tên nhà cung cấp:</label>
                                                                <input type="text" class="form-control" id="category-film" name="tennhacungcap" required>
                                                        </div>
                                                        </div>
                                                    </div>
                                                        <div class="modal-footer">
